import antwerp from './mockCities/antwerp.json';
import chicago from './mockCities/chicago.json';
import toronto from './mockCities/toronto.json';
import san_francisco from './mockCities/san_francisco.json';
